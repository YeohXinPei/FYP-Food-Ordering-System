        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">All Customer Bookings</h4>
                                ...
                                <table id="myTable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                             ...
                                             INNER JOIN table_booking ON users.u_id = table_booking.u_id';
...
?>
                                        <td>
                                            <button type="button" class="btn btn-warning" style="font-weight:bold;">
                                                <span class="fa fa-bars" aria-hidden="true">Booked
                                            </button>
                                        </td>
                                        <?php
...
?>
                                        <td>
                                            <button type="button" class="btn btn-warning">
                                                <span class="fa fa-check-circle" aria-hidden="true">Confirmed
                                            </button>
                                        </td>
                                        <?php
...
?>
                                        <?php																									
																							echo '	<td>'.$rows['book_date'].'</td>';
																							?>


                                        <td>
                                            <a href="delete_booking.php?booking_del=<?php echo $rows['b_id'];?>"
                                                onclick="return confirm('Are you sure?');"
                                                class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i
                                                    class="fa fa-trash-o" style="font-size:16px"></i></a>

                                            <a href="update_booking.php?booking_upd=<?php echo $rows['b_id'];?>"
