					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update dishes set cat_id='$_POST[cat_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',img='$fnew' where d_id='$_GET[menu_upd]'";  // update the submited data ino the database :images
												mysqli_query($db, $sql); 
